    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aadhaar', models.BigIntegerField(blank=True, null=True, validators=[django.core.validators.RegexValidator('^\\d{12}$', 'Aadhaar number must be 12 digits.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='product_images')),
                ('description', models.TextField()),
                ('main_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='categories', to='globalStoreApp.maincategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='globalStoreApp.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='product_images')),
                ('imageMain', models.CharField(blank=True, max_length=200)),
                ('images', models.CharField(blank=True, max_length=1000)),
                ...
                ('store', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='globalStoreApp.store')),
                ('tag', models.ManyToManyField(blank=True, to='globalStoreApp.tags')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discountedTotalAmount', models.FloatField(blank=True, null=True)),
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='globalStoreApp.customer')),
                ('deliveryPartner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='globalStoreApp.deliverypartner')),
                ('orderItem', models.ManyToManyField(to='globalStoreApp.orderitem')),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='globalStoreApp.store')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='globalStoreApp.category')),
                ('store', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='globalStoreApp.store')),
            ],
        ),
        migrations.CreateModel(
            name='Story',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'Credit'), (1, 'Debit'), (2, 'withdraw request')])),
                ('remark', models.CharField(max_length=200)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='globalStoreApp.customer')),
                ('orderId', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='globalStoreApp.order')),
            ],
        ),
        migrations.CreateModel(
            name='Variant',
            fields=[
                ...
                ('image', models.ImageField(upload_to='product_images')),
                ('description', models.TextField()),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='globalStoreApp.category')),
            ],
        ),
        migrations.AddField(
            model_name='product',
