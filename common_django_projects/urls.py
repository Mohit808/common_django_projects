...
from globalStoreApp.views import index,GetMainCategories,GetProducts, GetVariants, GetDashboard, GetHotDeals, CreateOrders, GetOrders, MyAddress, GetBannner  
...
urlpatterns = [
    ...
    path('getBannner', GetBannner.as_view()),
